...
translate_date: 2025-07-18T22:57:15.884220
...
Lorsque vous utilisez QuickTime Player, le seul problème est le son : Les choix disponibles sont _Microphone interne_ ou _Aucun_. Cela convient bien si vous souhaitez enregistrer un tutoriel où le son est ce que vous expliquez via le microphone, mais cela ne convient pas à ma situation.
...
_Lancer la Configuration Audio MIDI via Spotlight_

Une fois dans le programme Configuration Audio MIDI, créez un nouveau périphérique audio (logique) : cliquez sur le bouton "**+**" dans le coin inférieur gauche et sélectionnez "_Créer un périphérique de sortie multiple_". Dans le panneau qui apparaît à droite, sélectionnez "_Haut-parleur MacBook_" ET "_Soundflower (2ch)_".
