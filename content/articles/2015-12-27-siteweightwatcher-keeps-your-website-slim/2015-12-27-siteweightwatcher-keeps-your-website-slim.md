...
excerpt: An idea for a monitoring tool that continuously tests production websites for performance degradation, tracking page weight and load times over time.
---
