...
Vous pouvez laisser le journaliseur de ping fonctionner sur du matériel extrêmement simple. Il peut fonctionner jour et nuit, collectant des données. Le format est _brut_. Un exemple :
