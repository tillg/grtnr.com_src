...
date: 2016-01-08
image: ping.png
excerpt: Un outil simple en deux composants pour la journalisation et la visualisation à long terme du ping qui répond enfin à la question de savoir si c'est le WIFI, l'accès à Internet ou l'application qui est lente.
title: Visualisation et Analyse de Ping
tags: tech
translation: fr
source_language: en
source_hash: b8e1c642e2db4162fd47dde0b595cbafa4804738e699aec9408da33124f7fbb3
translator: gpt-4o-2024-08-06
translate_date: 2026-02-28T09:26:40.843482+00:00
generated_by: simplified-translation-system
---

Voici la situation à laquelle je fais face : j'utilise un accès Internet qui ne semble pas fiable. Parfois, c'est vraiment rapide, parfois, cela semble très peu fiable. Et je ne sais jamais quelle partie exactement est défaillante : est-ce l'application qui est lente, est-ce le WIFI, est-ce l'accès à Internet.
...
Puis j'ai trouvé quelque chose qui est en essence exactement ce que je cherchais. Reformulons : si j'avais commencé à assembler quelque chose moi-même, c'est ce que j'aurais construit : cela s'appelle [Visualisation et Analyse de Ping](http://www.medienvilla.com/entwicklung.html#pinganalyse) et c'est basé sur 2 composants :
...
Vous pouvez laisser le journaliseur de ping fonctionner sur du matériel très simple. Il peut fonctionner jour et nuit, collectant des données. Le format est _simple_. Un exemple :
...
- Améliorer le graphique :
  ...
  - Avoir des étiquettes sur l'axe des y
  - Peut-être les avoir plus [comme ceci](http://pinglogger.co.uk/index.php/screenshots/)
- Peut-être se pencher sur [log stash](https://www.elastic.co/products/logstash) pour la visualisation...

## Addendum
Également dans ce contexte, et parce que [Java est le langage de développement de l'année 2015](http://www.tiobe.com/index.php/content/paperinfo/tpci/index.html) : [Un programme Java pour suivre les temps de ping vers plusieurs points d'extrémité](http://pastebin.com/1qnCXDw7)