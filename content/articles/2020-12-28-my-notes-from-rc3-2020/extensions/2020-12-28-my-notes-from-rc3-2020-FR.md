...
translate_date: 2026-02-27T10:07:01.975603+00:00
...
Que s'est-il passé l'année dernière, quels sujets sont brûlants ?
...
- Les appareils SmartHome ont été convoqués comme témoins devant le tribunal : Alexa a raconté ce qui lui a été demandé.
...
- Il y a un bug dans le RGPD (Article 2) : Le gouvernement peut accéder à toutes les données en cas de danger. Trop vague comme description et cela brise l'idée de base du RGPD.
- En Suisse, certains cantons mettent à jour leur Constitution pour l'étendre à l'espace numérique.

Je suis seulement resté 15 minutes, je n'ai pas écouté jusqu'à la fin...
...
![Chiffres BitTorrent](image-4.png)
...
- Centralisé : Facebook. Fédéré : matrix. Réseau décentralisé ?
...
- Le consensus peut être atteint par _Preuve de travail_ ou par _Preuve d'enjeu_.
