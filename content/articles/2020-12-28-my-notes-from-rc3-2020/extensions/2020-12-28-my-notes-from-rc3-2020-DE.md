...
slug: meine-notizen-von-der-rc3-2020
...
translate_date: 2025-07-18T22:28:13.719468
...
Alle Vorträge sind [hier](https://media.ccc.de/c/rc3) verfügbar. Ich habe einige von ihnen (teilweise oder vollständig) angesehen.

Neben den Vorträgen gab es eine _2D-Welt_ - die bei mir nie funktionierte 😢 (und meine Netzwerkverbindung war ziemlich gut!):
...
- Funktionen von Tox: Sofortnachrichten, Sprachanrufe, Videoanrufe, Bildschirmfreigabe, Dateifreigabe, Gruppen.

Es war interessant zu erfahren, dass es VIELE Chat-Protokolle gibt. Und viele von ihnen haben ähnliche Ziele: Die Daten sicher zu halten und manchmal sogar die Metadaten. Es scheint eine Entscheidung zu sein, ob Ihr Protokoll wirklich die Metadaten verbirgt (normalerweise wird dies durch die Verwendung von Tor erreicht) oder ob es eine geringe Latenz bietet, um auch Sprach- und Videoanrufe zu ermöglichen.
...
- In der Schweiz aktualisieren einige Kantone ihre Verfassung, um sie auf den digitalen Raum auszudehnen.

Nur 15 Minuten reingehört, nicht bis zum Ende zugehört...

![Wikipedia](image-3.png)

### Bausteine der Dezentralisierung

Der Redner ist [Will Scott](https://www.linkedin.com/in/willrscott/). Er scheint ein IPFS-Typ zu sein.

- Derzeit ist das größte dezentrale System BitTorrent
...
- DHT: Verteilte Hashtabellen
- BFT (Byzantine Fault Tolerance) Konsens. Eine Erklärung scheint es [hier](https://academy.binance.com/en/articles/byzantine-fault-tolerance-explained) zu geben.
