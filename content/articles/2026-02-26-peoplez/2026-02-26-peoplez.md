...
**LinkedIn linking** — The fastest "get the identity right" path. [LinkedIn positions QR codes](https://www.linkedin.com/help/linkedin/answer/a525286/using-a-linkedin-qr-code-to-connect-with-members) as a way to connect with people you meet offline. Peoplez would pick up connections made on LinkedIn and enrich or update the contact - in one action instead of three. Peoplez would look for recently added LinkedIn links and suggest me to add them, with the possibility to add data.
