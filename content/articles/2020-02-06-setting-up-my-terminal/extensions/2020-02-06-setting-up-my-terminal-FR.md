...
date: 2020-02-06
image: terminal.png
excerpt: Un guide pour configurer un terminal macOS avec zsh, Oh My Zsh et powerlevel10k, en se concentrant sur la façon dont les éléments s'assemblent plutôt que sur une installation étape par étape.
...
translate_date: 2026-02-28T09:26:50.228735+00:00
...
- En 2007, bash est passé à la [Licence Publique Générale GNU 3.0](https://www.gnu.org/licenses/gpl-3.0.en.html), ce qui ne plaisait pas à Apple pour certaines raisons. Ils sont donc restés avec la version de bash d'avant 2007. Et c'est vieux - y compris [une vulnérabilité](<https://www.wikiwand.com/en/Shellshock_(software_bug)>) qui a obligé Apple à mettre à jour bash pour les Macs.
...
En gros, Oh My Zsh rend votre terminal très agréable (via [les thèmes](https://github.com/ohmyzsh/ohmyzsh/wiki/Themes)) et offre de nombreux plugins utiles. Voici une liste d'exemples de leur [page github](https://github.com/ohmyzsh/ohmyzsh) :
