...
translate_date: 2026-02-27T10:10:18.092494+00:00
generated_by: simplified-translation-system
---

[TOC]

Le week-end dernier, j'ai découvert cette vidéo de David Ondrej : [I spent 400+ hours in Cursor, here’s what I learned](https://youtu.be/gYLNxUxVomY?si=1Q2x2UWgqy1RHvLt). Le titre n'est pas très attractif, mais le contenu m'a été très utile. Voici donc mes notes pour que je puisse utiliser tous ses conseils et avoir les différentes invites et extraits à portée de main lorsque je code.
...
- ﻿﻿en cas de doute sur ce qu'il faut faire, dire à l'utilisateur d'effectuer une recherche web
...
- Inclure BEAUCOUP de commentaires explicatifs dans votre code. TOUJOURS écrire du code bien documenté.
...
David fournit une liste de petites invites utiles ou d'extraits d'invites. J'en ai copié quelques-uns ici pour une utilisation copier/coller :

```text
Agir comme un Développeur Senior avec un accent sur une architecture claire.
...
puis, après avoir terminé, dites-moi si l'une de ces solutions est manifestement meilleure que l'autre, et pourquoi.
```
