...
date: 2025-08-03
image: swiftui.png
excerpt: Mon aide-mémoire, créé en suivant [100 Days of SwiftUI](https://www.hackingwithswift.com/100/swiftui/).
...
translate_date: 2026-02-27T10:15:57.305110+00:00
generated_by: simplified-translation-system
---

En juin 2025, j'ai commencé à travailler sur [100 Days of SwiftUI](https://www.hackingwithswift.com/100/swiftui/). C'est un excellent cours, et je suis vraiment impressionné par la qualité du contenu et des cours que Paul Hudson propose - et maintient !! Paul, merci beaucoup pour cela ! 🙏🏼
...
Pour un aperçu complet, voir [Learn essential Swift in one hour](https://www.hackingwithswift.com/articles/242/learn-essential-swift-in-one-hour).
...
Remarque : Les champs de texte avec des styles différents peuvent être _additionnés_ pour former un grand champ de texte avec des parties de styles différents à l'intérieur :
...
Couvert dans [Day 32-34](https://www.hackingwithswift.com/100/swiftui/32). TODO Je dois revoir les clips pour extraire mes notes/aide-mémoire.
...
### Passage et retour de valeurs vers/depuis des vues

Comme vu dans [Selecting and editing map annotations](https://www.hackingwithswift.com/books/ios-swiftui/selecting-and-editing-map-annotations)

Imaginez que j'ai une vue qui est ouverte en tant que feuille et qui reçoit un `Location` (étant une `struct` définie par l'utilisateur) :
...
Pour passer le `Location`, je crée un initialiseur supplémentaire :
...
Cette partie `@escaping` est importante, et signifie que la fonction est mise de côté pour une utilisation ultérieure, plutôt que d'être appelée immédiatement, et c'est nécessaire ici car la fonction `onSave` sera appelée uniquement lorsque l'utilisateur appuiera sur Enregistrer.
...
Rendre les données `Codable` n'est généralement pas trop difficile : Tant que les composants sont `Codable`, l'ensemble de la classe l'est également.
...
do {
    try data.write(to: url, options: [.atomic, .completeFile