...
excerpt: Comment créer un volume avec docker-compose, utilisé par de nombreux conteneurs et à un emplacement spécifique sur l'hôte.
...
translate_date: 2026-02-27T10:07:37.549318+00:00
...
Le détail que j'ai manqué pendant si longtemps était la section **volumes** avec les **driver_opts**. Et bien que j'aie effectué quelques tests et que tout se soit comporté exactement comme je l'espérais, je n'ai pas pu trouver de documentation appropriée. Voici ce que dit la [documentation docker](https://docs.docker.com/compose/compose-file/compose-file-v3/#driver_opts) à propos des **driver_opts** :
...
- Voici l'article le plus utile de [Stackoverflow](https://stackoverflow.com/questions/35841241/docker-compose-named-mounted-volume).
