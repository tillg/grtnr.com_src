...
[en→de] <p>While working on a side project that uses <strong>docker-compose</strong>, I stumbled over a problem. One that I had encountered before but had never properly investigated or solved.</p>
