...
translate_date: 2026-02-27T10:09:31.990453+00:00
generated_by: simplified-translation-system
---

![Image drôle de l'IA](dev_tools.png)

Je ne suis pas un développeur professionnel, je le fais pour le plaisir. Et j'aime explorer, découvrir de nouvelles technologies, développer toutes sortes de petites choses. Donc parfois j'ai besoin de Python, parfois de React/Typescript, Java et plus encore. Pour chaque outil de développement ou langage, il existe plusieurs options pour les installer et gérer leurs versions. Comme j'ai tendance à oublier des choses comme "Comment ai-je installé Python sur cette machine ?", ceci est une note pour moi-même dans le futur, me disant comment j'ai installé chaque outil de développement.

Comme la manière dont certains packages sont installés peut changer au fil du temps, j'ajouterai des dates à mes choix d'installation.
...
# Si ce n'est pas zsh, le définir comme défaut
chsh -s "$(which zsh)"
...
- `sdk list java` affiche toutes les versions de Java disponibles (disponibles pour installation)
- Pour lister les versions de Java installées :
  - `sdk offline enable`, afin qu'il liste uniquement les versions installées localement
  - `sdk list java`
  - `sdk offline disable`
