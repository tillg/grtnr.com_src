...
translate_date: 2026-02-28T09:40:44.531621+00:00
...
- Puis j'annote à nouveau, exécute `/spec-iterate` à nouveau, et ainsi de suite.
- Quand je sens que tout semble correct, je démarre une conversation `/new` et exécute `/spec-ready-or-not spec.md`.
...
1. Cherchez toujours les annotations de l'utilisateur (par exemple, flèches '->', balises comme [ACCEPTED], [REJECTED]) dès le PREMIER passage — ne nécessite pas de relance.
