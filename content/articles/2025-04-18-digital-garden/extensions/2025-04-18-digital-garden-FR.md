...
Source-Language: en
Translator: gpt-4o
Translate-Date: 2025-07-04T16:42:02.452386
...
- Mettre les sujets plus en avant plutôt que la date : Mon blog est principalement structuré et présenté par date. Avoir le(s) sujet(s) plus comme structure de navigation semble attrayant. Bien sûr, je laisserais toujours la date de création, ainsi que la date de la dernière modification.
...
- Liens internes comme _[ [liens] ]_. Et afficher les rétroliens dans les articles liés.
...
Dans ce cas, nous définissons `Template: recette` qui indique à Pelican de rendre cette page avec `recette.html` au lieu du template par défaut ([Writing content — Pelican 4.7.2 documentation](https://docs.getpelican.com/en/4.7.2/content