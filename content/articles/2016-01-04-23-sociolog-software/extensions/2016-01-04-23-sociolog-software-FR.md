...
translate_date: 2026-02-28T14:26:02.723685+00:00
...
- Ce [blog](http://tillgartner.com) [site n'existant plus]

De temps en temps, j'aime bien faire défiler mon passé. Je le fais le plus souvent sur notre blog familial, car il contient le contenu le plus intéressant et parce qu'il est facile à parcourir. J'aimerais pouvoir faire défiler tout mon passé à travers tous les médias.
...
- Gérer correctement le contenu dupliqué : Depuis quelques années, mon compte Twitter est _lié_ à mon compte Facebook de sorte que les entrées Twitter sont répliquées sur Facebook. C'est parce que j'ai des personnes que je considère comme _public_ sur les deux médias.
- Recueillir également les retours sur mes publications
- Les afficher joliment de manière statique, y compris des pages d'aperçu

Quelques réflexions techniques :

- Je l'écrirais en java car c'est ce que je connais le mieux
- Ce serait un programme sans interface utilisateur
