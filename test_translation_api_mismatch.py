        ...
        try:
            ...
            try:
                ...
                if hasattr(result, "translation"):
                    ...
                    print(
                        "❌ result.translation missing - plugin expects this attribute"
                    )
                    return False
            ...
            print(
                "The new TranslationService appears to have the correct API interface."
            )
            return True
...
def test_old_translation_service_api():
    ...
    try:
        ...
        try:
            ...
            try:
                old_service = OldTranslationService(
                    language_detector=None, translator=None, cache_dir="cache"
                )
        ...
        try:
            ...
            if isinstance(result, tuple) and len(result) == 2:
                ...
                print(
                    f"✅ Old API returns tuple: ({type(translated_content)}, {type(source_language)})"
                )
...
def compare_api_signatures():
    ...
    print(
        "  result.translation  # expects TranslationResult with .translation attribute"
    )
    ...
    print(
        "2. ✅ Return type compatibility: NEW API returns TranslationResult with expected attributes"
    )
    print("3. ✅ detect_language() method: Compatible")
    print(
        "4. ⚠️  Method name difference: get_available_languages() vs get_supported_languages()"
    )
    print()
